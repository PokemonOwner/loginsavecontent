...
API_ID = int(os.getenv("TG_API_ID", "29554659"))
API_HASH = os.getenv("TG_API_HASH", "7257d3b3192355ae71ada27cfdc3837c")
BOT_TOKEN = os.getenv("BOT_TOKEN", "7067097829:AAFbTZCPM7Z_uBVuCGsGtG1qBej5AzBZfsE")
MONGODB_URL = os.getenv("MONGODB_URL", "mongodb+srv://techmonofficial:<83CNugFw1yJ4HtHO>@cluster0.wo0hzaa.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
BOT_USERNAME = HarrySaveContentBot
